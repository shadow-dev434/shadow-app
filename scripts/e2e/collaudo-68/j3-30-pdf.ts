/**
 * Collaudo 68 — J3 Step 3b: PDF minimale valido (1 pagina, "Scadenza F24: 30 luglio")
 * come attachment { kind: 'document', mediaType: 'application/pdf' }.
 * Baseline 62: PDF LETTO, create_task "Pagare F24" deadline 2026-07-30 nello stesso
 * turno (docs/tasks/62-evidenze/J3/pdf-result.json). Atteso: stesso esito.
 *
 * Uso: bun scripts/e2e/collaudo-68/j3-30-pdf.ts
 */
