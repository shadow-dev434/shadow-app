      ...
      sections={[
        {
          ...
          blocks: [
            { p: `Il titolare del trattamento è Giulio Errico, persona fisica, contattabile all'indirizzo egiulio.psi@gmail.com.` },
          ],
        },
        {
          h: `2. Premessa`,
          blocks: [
            { p: `Shadow è un'applicazione di gestione dei compiti, a conversazione, pensata per adulti con ADHD. È attualmente in fase beta su invito. Questa informativa descrive quali dati trattiamo, perché, con quali strumenti e quali diritti hai. Ti chiediamo di leggerla prima di iniziare.` },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `Trattiamo questi dati solo sulla base del tuo consenso esplicito (art. 9, par. 2, lett. a). Senza questo consenso non possiamo offrirti la funzione conversazionale e di personalizzazione e, poiché sono l'essenza di Shadow, l'app non può funzionare.` },
          ],
        },
        {
          h: `5. Finalità del trattamento e basi giuridiche`,
          blocks: [
            { ul: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { p: `Per ridurre i dati esposti, i tuoi dati identificativi (email, nome) non vengono inviati ad Anthropic. Non mostriamo pubblicità e non vendiamo i tuoi dati.` },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            ...
            { ul: [
              ...
              `in caso di inattività prolungata, cancelliamo i dati dopo 12 mesi di inattività;`,
        ...
        },
        {
          ...
          blocks: [
            { p: `Potremmo aggiornare questa informativa. In caso di modifiche sostanziali, incluso il passaggio della titolarità dalla persona fisica alla società (SRL) in via di costituzione, te ne daremo comunicazione.` },
          ],
        },
        {
          h: `12. Versione`,
